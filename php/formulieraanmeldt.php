...
<link rel="stylesheet" type="text/css" href="../css1.css">
		<style>
			body
			{
				background-image:url("../images/Fall-hd-great-desktop-backgrounds.jpg");
			}
...
<main>	
<?php
	require 'config.inc.php';														//voeg het bestand config.php toe
...
?>
	...
	<form method="post" action="formulieraanmeldt_verwerk.php">
		<table width="200" border="0">
			...
			<tr>
				<td>Klas</td>
				<td><input type="text" name="Klas" value="<?php echo $rij['Klas'] ?>" readonly ></td>
			</tr>
			<tr>
				<td>Wilt u komen?</td>
				<td>
					<input type="radio" name="komt" value="Y">
					Ja
					<input type="radio" name="komt" value="N">
					Nee
				</td>
			</tr>
			<tr>
			<td>Zo ja, kies een tijd naar wens!</td><br>
			<?php
			$klas = $rij['Klas'];
			...
			<td>
    		<select name="tijd">
    			<option selected disabled>Kies uw tijd.</option>
